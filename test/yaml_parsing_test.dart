...
void main() {
  test('parsing-testMessages.i69n.yaml', () async {
    final parser = YamlParser();
    final actual = await parser.parse('test/testMessages.i69n.yaml');
    ...
    final expected = LocaleFile(Metadata('sk', ''), [
      ...
      Node(
        ...
        NodeListNodeValue([
          ...
          Node(
              StringNodeKey('help'), StringNodeValue('Use this function to generate new invoices and stuff. Awesome!')),
          Node(
